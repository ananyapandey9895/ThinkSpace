            ...
            <div className="flex items-end gap-3">
                ...
                <div className="flex-1 relative">
                    <textarea
                        ...
                        disabled={disabled}
                        rows={1}
                        className="w-full px-4 py-2.5 bg-slate-100 rounded-3xl resize-none focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all max-h-32 text-sm"
                        style={{
                            minHeight: "44px",
                            height: "auto",
                        }}
