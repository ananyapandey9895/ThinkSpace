        ...
        <MainLayout>
            <div className="relative mb-8">
                <div className="h-64 md:h-80 rounded-3xl overflow-hidden shadow-lg shadow-indigo-100 relative">
                    ...
                    <img src="https://images.unsplash.com/photo-1614850523459-c2f4c699c52e?w=1200&q=80" alt="Cover" className="w-full h-full object-cover opacity-80 mix-blend-overlay" />
                </div>
                    ...
                    <div className="flex flex-col md:flex-row items-end gap-6 -mt-16 md:-mt-20 mb-6">
                        <div className="relative shrink-0">
                            ...
                            <div className="absolute bottom-2 right-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-bold px-3 py-1.5 rounded-full border-2 border-white shadow-md flex items-center gap-1.5">
                                <Zap size={12} className="fill-current" /> Thinker
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="flex-1">
                            ...
                            <div className="flex gap-4 mt-4 text-sm text-slate-500 font-medium">
                                <span className="flex items-center gap-1 hover:text-indigo-600 cursor-pointer transition-colors"><Zap size={16} /> 2 spaces</span>
                                <span className="flex items-center gap-1 hover:text-indigo-600 cursor-pointer transition-colors"><Users size={16} /> 7 thinkers</span>
                            </div>
                        </div>
